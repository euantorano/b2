// Package b2 provides an interface to the Backblaze B2 file storage service.
package b2
...
const (
	v1AuthAccountURL string = "https://api.backblaze.com/b2api/v1/b2_authorize_account"
)
...
func NewClient(credentials Credentials) (*Client, error) {
	if req, err := http.NewRequest("GET", v1AuthAccountURL, nil); err != nil {
		return nil, err
	} else {
